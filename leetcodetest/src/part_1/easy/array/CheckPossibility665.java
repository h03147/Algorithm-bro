...
public class CheckPossibility665 {
    public static void main(String[] args) {
        int[] nums1 = {4, 2, 3};
        int[] nums2 = {4, 2, 1};
        System.out.print(checkPossibility(nums1) + "," + checkPossibility(nums2));
    }
    ...
    public static boolean checkPossibility(int[] nums) {
         ...
         * 例子2， i 为 2 , i - 1为4, i - 1 前面的i - 2 位置上还有数 -1, 切-1 < 4 < 2, 则还是让i - 1       * 位置上的4改为i位置上的2即可
         * 例子3，i位置上是4，我们发现不仅i - 1 位置上5 > 4, 而且i - 2 位置上5也大于4，这种情况下，我们         * 需要把i位置上的4修改成i - 1 位置上的值5即可
